...
public static class SecurityHelper
{
    ...
    /// </summary>
    public static string ToBase64(string input, System.Text.Encoding? encoding = null)
    {
        ArgumentNullException.ThrowIfNull(input);
        return Convert.ToBase64String((encoding ?? System.Text.Encoding.UTF8).GetBytes(input));
    }
    ...
    public static bool FixedTimeEquals(string? left, string? right)
    {
        ...
        var maxLength = System.Math.Max(leftBytes.Length, rightBytes.Length);
